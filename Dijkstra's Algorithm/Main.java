...
public class Main {
	...
	public static void main(String[] args) {
		...
		// can we do Dijkstra using only nodeDistances and not adjacencies?
		// Testing the HashMaps
		System.out.println("Node distances from A: " + threeNodes.nodeDistances.get("A")); // this drops the HashMap to adjacent nodes for A on the floor
		...
		Dijkstra dijkstra = new Dijkstra(threeNodes.nodeDistances, startNode, destNode);
